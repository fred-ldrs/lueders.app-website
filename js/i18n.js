...
var TRANSLATIONS = {
  en: {
    ...
    'pw-souvenirbird-desc': "Memory app — capture kids' moments & anecdotes, stress-free",
    'pw-bebebirdie-desc': 'Sleep aid for babies — lullabies & soothing sounds',
    'pw-googleplay-desc': 'Google Play Developer Account',
    'group-snap-title': 'Snap it. Keep it. — snapitkeepit.com',
    'group-snap-desc': 'Memory app · Rebranding in progress',
    'group-save2keep-title': 'save 2 keep',
    'group-save2keep-desc': 'Memory apps · Web + Android',
    'badge-indev': 'In Development',
    'group-satsit-title': "SAT'S IT",
    'group-satsit-desc': 'Bitcoin Education · Web + Android',
  ...
  de: {
    ...
    'pw-souvenirbird-desc': 'Erinnerungs-App — kurze Anekdoten & Momente der Kinder stressfrei festhalten',
    'pw-bebebirdie-desc': 'Einschlafhilfe für Babys — Melodien & beruhigende Klänge',
    'pw-googleplay-desc': 'Google Play Entwicklerkonto',
    'group-snap-title': 'Snap it. Keep it. — snapitkeepit.com',
    'group-snap-desc': 'Erinnerungs-App · Rebranding in Arbeit',
    'group-save2keep-title': 'save 2 keep',
    'group-save2keep-desc': 'Erinnerungs-Apps · Web + Android',
    'badge-indev': 'Im Aufbau',
    'group-satsit-title': "SAT'S IT",
    'group-satsit-desc': 'Bitcoin Bildung · Web + Android',
  ...
  fr: {
    ...
    'pw-souvenirbird-desc': "App souvenirs — notez facilement les petits moments & anecdotes de vos enfants",
    'pw-bebebirdie-desc': 'Aide à l\'endormissement — berceuses & sons apaisants',
    'pw-googleplay-desc': 'Compte développeur Google Play',
    'group-snap-title': 'Snap it. Keep it. — snapitkeepit.com',
    'group-snap-desc': 'App mémoire · Rebranding en cours',
    'group-save2keep-title': 'save 2 keep',
    'group-save2keep-desc': 'Apps mémoire · Web + Android',
    'badge-indev': 'En développement',
    'group-satsit-title': "SAT'S IT",
    'group-satsit-desc': 'Éducation Bitcoin · Web + Android',
