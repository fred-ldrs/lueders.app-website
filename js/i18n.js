...
var TRANSLATIONS = {
  en: {
    ...
    'group-trivia-desc': 'Rebranded quiz hub · Fun quizzes · Web + Android',
  ...
  de: {
    ...
    'projects-heading': 'Projekte',
    'group-trivia-title': 'Quiz Hub',
    'group-trivia-desc': 'Rebrandeter Quiz-Hub · Spaß-Quizzes · Web + Android',
  ...
  fr: {
    ...
    'group-trivia-title': 'Quiz Hub',
    'group-trivia-desc': 'Hub quiz rebrandé · Quiz amusants · Web + Android',
